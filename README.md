...
function a:Window(w)
    ...
    A.Color =
        ColorSequence.new {
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(150, 213, 255)),
        ColorSequenceKeypoint.new(0.20, Color3.fromRGB(150, 213, 255)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(150, 213, 255)),
        ColorSequenceKeypoint.new(0.80, Color3.fromRGB(150, 213, 255)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(150, 213, 255))
    }
